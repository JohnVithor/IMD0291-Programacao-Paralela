...
without_transpose = add_col(without_transpose, parallel_data.loc["for_parallel"].loc[4], "4")
without_transpose = add_col(without_transpose, parallel_data.loc["for_parallel"].loc[8], "8")
without_transpose = add_col(without_transpose, parallel_data.loc["for_parallel"].loc[16], "16")
without_transpose = add_col(without_transpose, parallel_data.loc["for_parallel"].loc[32], "32")

save_with_speedup_efic(without_transpose, "for_without_transpose")

without_transpose = serial_data.loc["serial"].reset_index()
without_transpose.columns = ["Tamanho do Problema", "Serial"]
without_transpose = without_transpose.set_index("Tamanho do Problema")
without_transpose = add_col(without_transpose, parallel_data.loc["task_parallel"].loc[4], "4")
without_transpose = add_col(without_transpose, parallel_data.loc["task_parallel"].loc[8], "8")
without_transpose = add_col(without_transpose, parallel_data.loc["task_parallel"].loc[16], "16")
without_transpose = add_col(without_transpose, parallel_data.loc["task_parallel"].loc[32], "32")

save_with_speedup_efic(without_transpose, "task_without_transpose")
...
with_transpose = add_col(with_transpose, parallel_data.loc["for_parallel_transpose"].loc[4], "4")
with_transpose = add_col(with_transpose, parallel_data.loc["for_parallel_transpose"].loc[8], "8")
with_transpose = add_col(with_transpose, parallel_data.loc["for_parallel_transpose"].loc[16], "16")
with_transpose = add_col(with_transpose, parallel_data.loc["for_parallel_transpose"].loc[32], "32")

save_with_speedup_efic(with_transpose, "for_with_transpose")

with_transpose = serial_data.loc["serial_transpose"].reset_index()
with_transpose.columns = ["Tamanho do Problema", "Serial Transpose"]
with_transpose = with_transpose.set_index("Tamanho do Problema")
with_transpose = add_col(with_transpose, parallel_data.loc["task_parallel_transpose"].loc[4], "4")
with_transpose = add_col(with_transpose, parallel_data.loc["task_parallel_transpose"].loc[8], "8")
with_transpose = add_col(with_transpose, parallel_data.loc["task_parallel_transpose"].loc[16], "16")
with_transpose = add_col(with_transpose, parallel_data.loc["task_parallel_transpose"].loc[32], "32")

save_with_speedup_efic(with_transpose, "task_with_transpose")
